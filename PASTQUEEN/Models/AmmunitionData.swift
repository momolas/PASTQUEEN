...
struct AmmunitionData {
    ...
    static let catalogWeapons: [CatalogWeapon] = [
        ...
        // Savage
        CatalogWeapon(manufacturer: "Savage", name: "B22 Varmint", caliber: ".22 LR", twistRateInches: 16.0, twistDirection: .right, sightHeightCM: 4.0, defaultScopeUnit: .moa18, category: "Canon Lourd Varmint .22"),
        CatalogWeapon(manufacturer: "Savage", name: "B22 Precision Varmint", caliber: ".22 LR", twistRateInches: 16.0, twistDirection: .right, sightHeightCM: 4.0, defaultScopeUnit: .moa18, category: "Châssis MDT Rimfire"),
        ...
        CatalogWeapon(manufacturer: "Savage", name: "Axis II", caliber: ".308 Win", twistRateInches: 10.0, twistDirection: .right, sightHeightCM: 3.8, defaultScopeUnit: .moa14, category: "Verrou Standard"),
        CatalogWeapon(manufacturer: "Savage", name: "Axis II", caliber: ".223 Rem", twistRateInches: 9.0, twistDirection: .right, sightHeightCM: 3.8, defaultScopeUnit: .moa14, category: "Verrou Standard"),
        CatalogWeapon(manufacturer: "Savage", name: "Axis II", caliber: "6.5 Creedmoor", twistRateInches: 8.0, twistDirection: .right, sightHeightCM: 3.8, defaultScopeUnit: .moa14, category: "Verrou Standard"),
        CatalogWeapon(manufacturer: "Savage", name: "Axis II", caliber: ".30-06", twistRateInches: 10.0, twistDirection: .right, sightHeightCM: 3.8, defaultScopeUnit: .moa14, category: "Verrou Standard"),
